package com.roboquarks.miniphysgre.theory.thermodynamics;
...
import com.roboquarks.miniphysgre.theory.thermodynamics.fragments.ClassicalThermodynamics;
import com.roboquarks.miniphysgre.theory.thermodynamics.fragments.GasLaws;
import com.roboquarks.miniphysgre.theory.thermodynamics.fragments.KineticTheory;
import com.roboquarks.miniphysgre.theory.thermodynamics.fragments.StatisticalThermodynamics;
...
public class Thermodynamics extends AppCompatActivity
{
    ...
    String[] chapters = {"Classical Thermodynamics" , "Gas Laws", "Kinetic Theory", "Statistical Thermodynamics"};

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gre_formulas_thermodynamics);
    ...
    private void Init()
    {
        ...
        listView = (ListView)findViewById(R.id.thermodynamics_listView);
