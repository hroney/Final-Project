package com.roboquarks.miniphysgre.theory.special_relativity;
...
public class SpecialRelativity extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gre_formulas_special_relativity);
    ...
    private void Init()
    {
        ...
        listView = (ListView)findViewById(R.id.special_relativity_listView);
